...
trait AgentSpecificTechniqueWriter {
  ...
  def agentMetadata ( technique : EditorTechnique, methods : Map[BundleName, GenericMethod], noReportingBundle : Boolean ) : PureResult[NodeSeq]
}
...
class DSCTechniqueWriter(
  ...
  def agentMetadata(technique : EditorTechnique, methods : Map[BundleName, GenericMethod], noReportingBundle : Boolean ) = {
